...
INSERT INTO parking VALUES (1, '1', '20m, right') ON CONFLICT (id) DO NOTHING;
INSERT INTO parking VALUES (2, '1', '20m, right') ON CONFLICT (id) DO NOTHING;
INSERT INTO parking VALUES (3, '1', '20m, right') ON CONFLICT (id) DO NOTHING;
